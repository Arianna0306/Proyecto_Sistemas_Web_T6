<%-- 
    Document   : empresas
    Created on : 11 ene. 2021, 11:15:49
    Author     : nacho
--%>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <div id="cab-centrada"><h1 class="h3 mb-4 text-gray-800">EMPRESAS</h1></div>
                    <hr class="sidebar-divider">


                    <div class="empresas-c">

                        <!-- Page Heading -->
                        <h1>Seleccione la empresa</h1>
                        <select class="empresas-list" style="width: 7cm;">
                    ...
                    <div class="empresas">
                        ...
                        <form class="emp-form1">
                            ...
                            <input type="text" style="width: 12cm;" id="cif" name="cif"disabled required><br><br>
                            <label for="nom">Nombre empresa:</label><br>
                            <input type="text" style="width: 12cm;" id="nom" name="nom" disabled required><br><br>
                            <label for="act">Empresa Activa/No Activa:</label><br>
                            <input type="text" style="width: 12cm;" id="act" name="act" disabled required><br><br>
                        ...
                        <form class="emp-form2">
                            ...
                            <input type="text" style="width: 12cm;" id="tel" name="tel" disabled required><br><br>
                            <label for="dir">Dirección empresa:</label><br>
                            <textarea id="dir" name="dir" style="width: 12cm;height: 3cm;" cols="80" rows="5" disabled required></textarea>
                        </form>
                    </div>
                </div>
