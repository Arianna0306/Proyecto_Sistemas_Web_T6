<%-- 
    Document   : proyectos
    Created on : 11 ene. 2021, 12:03:38
    Author     : nacho
--%>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <div id="cab-centrada"><h1 class="h3 mb-4 text-gray-800">PROYECTOS</h1></div>
                    <hr class="sidebar-divider">


                    <div class="proyectos-c">

                        <!-- Page Heading -->
                        <h1>Seleccione el proyecto</h1>
                        <select class="proyectos-list" style="width: 7cm;">
                    ...
                    <div class="proyectos">
                        ...
                        <form class="emp-form1">
                            <label for="cif">CIF Empresa:</label><br>
                            <input type="text" style="width: 12cm;" id="cif" name="cif"><br><br>
                            <label for="act">Estado:</label><br>
                            <input type="text" style="width: 12cm;" id="act" name="act"><br><br>
                            <label for="id-p">ID proyecto:</label><br>
                            <input type="text" style="width: 12cm;" id="id-p" name="id-p"><br><br>
                            <label for="nom">Nombre proyecto:</label><br>
                            <input type="text" style="width: 12cm;" id="nom" name="nom"><br><br>
                        ...
                        <form class="emp-form2">
                            <label for="dir">Dirección proyecto:</label><br>
                            <textarea id="dir" name="dir" style="width: 12cm;height: 2.5cm;" cols="80" rows="5"></textarea><br><br>
                            <label for="desc">Descripción del proyecto:</label><br>
                            <textarea id="desc" name="desc" style="width: 12cm;height: 3cm;" cols="80" rows="5"></textarea><br><br>
                        </form>
