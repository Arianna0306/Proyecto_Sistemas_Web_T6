<%-- 
    Document   : perfil_empleado
    Created on : 11 ene. 2021, 11:19:02
    Author     : nacho
--%>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div id="cab-centrada"><h1 class="h3 mb-4 text-gray-800">TU PERFIL</h1></div>           

                    <!-- Divider -->
                    <hr class="sidebar-divider">

                    <div class="perfil_emp">
                        <form class="form-perf-emp">
