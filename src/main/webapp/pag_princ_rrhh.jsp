<%-- 
    Document   : pag_princ_rrhh
    Created on : 11 ene. 2021, 11:18:33
    Author     : nacho
--%>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="emp-rrhh">
                        ...
                        <label for="text-rrhh">Empresas activas</label><br>
                        <textarea id="text-rrhh" name="text-rrhh" style="width: 90%;height: 11cm;" cols="80" rows="20" disabled></textarea>
                    ...
                    <div class="pry-rrhh">
                        ...
                        <!-- Divider -->
                        <hr class="sidebar-divider">
                        <label for="text-rrhh">Proyectos activos</label><br>
                        <textarea id="text-rrhh" name="text-rrhh" style="width: 90%;height: 11cm;" cols="80" rows="20" disabled></textarea>
                    
                    </div>
                    <div class="emple-rrhh">
                        <h1>EMPLEADOS</h1>                

                        <!-- Divider -->
                        <hr class="sidebar-divider">

                        <label for="text-rrhh">Empleados activos</label><br>
                        <textarea id="text-rrhh" name="text-rrhh" style="width: 90%;height: 11cm;" cols="80" rows="20" disabled></textarea>
                    </div>
                </div>
