<%-- 
    ...
    Created on : 11 ene. 2021, 12:04:19
    Author     : nacho
--%>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <input type="submit" class="envia_sol" style="width: 5cm;" value= "Envía solicitud">
                    ...
                    <div class="tipo-solicitud">
                        ...
                        <form class="tipos">   
                            <label><input type="radio" name="types"> Dias libres</label><br>
                            <label><input type="radio" name="types"> Vacaciones</label><br>
                            <label><input type="radio" name="types"> Horas libre</label><br>
                            <label><input type="radio" name="types"> Deberes inexcusables</label><br>     
                        </form>
                    ...
                    <div class="fecha-solicitud">
                        ...
                        <form class="fecha">
                            ...
                            <input type="date" style="width: 5cm;" name="inicio"><br><br>
                            <label for="fin">Fecha de fin:</label><br>
                            <input type="date" style="width: 5cm;" name="fin"><br><br>
                        </form>
                        <form class="hora">
                            <label for="inicio-h">Hora de inicio:</label><br>
                            <input type="time" style="width: 5cm;" name="inicio-h"><br><br>
                            <label for="fin-h">Hora de fin:</label><br>
                            <input type="time" style="width: 5cm;" name="fin-h"><br><br>
                        </form>
                        
                    </div>
                    <div class="observaciones-solicitud">
                        ...
                        <form class="obs">
                            <label for="observaciones"  >Indique aquí las observaciones que crea necesarias:</label><br>
                            <textarea name="observaciones" style="width: 20cm;height: 2.5cm;" cols="40" rows="5"></textarea>
                        </form>
